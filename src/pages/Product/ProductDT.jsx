...
const product = [
  {
    id: 11,
    name: "French Fries With Classic Seasoning",
    image: "2.jpg",
    originalPrice: 40.0,
    discountPercent: 5,
  },
  {
    id: 12,
    name: "French Fries With Cheese Powder",
    image: "2.jpg",
    originalPrice: 40.0,
    discountPercent: 5,
  },
  ...
  {
    id: 24,
    name: "Bacon & Egg Grill Cheese Sandwich",
    image: "15.jpg",
    originalPrice: 80.0,
    discountPercent: 5,
  },
  ...
  {
    id: 29,
    name: "Meaty & Bacon Cheese Hotdog",
    image: "20.jpg",
    originalPrice: 100.0,
    discountPercent: 10,
  },
    ...
    <div className="px-20">
      ...
      >
        ...
        >
          ...
          <div className="flex ">
            <img
              src={require(`../../images/Burger/${prd.image}`)}
              alt=""
              width={405}
              height={405}
              style={{
