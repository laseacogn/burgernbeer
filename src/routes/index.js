...
import { Burger, Combo, Sidedish, Sandwich, Hotdog, Baguette, Pizza, Drink, ComboDetail, ComboDetail2, ComboDetail3, Product, Category, Category_Baguette} from '../pages';
import { Category_Burger, Category_Pizza } from '../pages';
